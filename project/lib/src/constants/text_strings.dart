...
const String tOnBoardingSubTitle3 =
    "Save time by just copy pasting complete apps learn from videos";
...
const String tAldreadyHaveAnAccount = "Already have an Account?";
...
const String tProfileHeading = "Melih Yumuşaker";
const String tProfileSubHeading = "superAdmin@melih.com";
